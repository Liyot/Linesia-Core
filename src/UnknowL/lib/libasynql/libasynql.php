...
namespace UnknowL\lib\libasynql;

use InvalidArgumentException;
use pocketmine\plugin\PluginBase;
use pocketmine\utils\Terminal;
use pocketmine\utils\Utils;
use UnknowL\lib\libasynql\base\DataConnectorImpl;
use UnknowL\lib\libasynql\base\SqlThreadPool;
use UnknowL\lib\libasynql\mysqli\MysqlCredentials;
use UnknowL\lib\libasynql\mysqli\MysqliThread;
use UnknowL\lib\libasynql\sqlite3\Sqlite3Thread;
...
final class libasynql{
	...
	public static function detectPackaged() : void{
		self::$packaged = __CLASS__ !== 'UnknowL\lib\libasynql\libasynql';
