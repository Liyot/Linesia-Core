...
class CustomForm extends BaseForm{
	 ...
	 * @phpstan-param \Closure(LinesiaPlayer, CustomFormResponse) : mixed $onSubmit
	...
	public function __construct(
		...
		Utils::validateCallableSignature(function(LinesiaPlayer $player, CustomFormResponse $response){ }, $onSubmit);
		if($onClose !== null){
			/** @phpstan-ignore-next-line */
	...
	private function validateElements(LinesiaPlayer $player, array $data) : void{
