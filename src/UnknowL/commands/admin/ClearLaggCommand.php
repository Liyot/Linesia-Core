...
class ClearLaggCommand extends BaseCommand
{
    ...
    {
        if (isset($args[0]) and ($args[0] === "force") and ($sender->hasPermission(DefaultPermissions::ROOT_OPERATOR))) {
            $count = 0;
        ...
        } else $sender->sendMessage("§d§l» §r§fLe prochain clearagg sera dans§d " . ClearLaggTask::$time . " §fseconde(s) !");
    }
}