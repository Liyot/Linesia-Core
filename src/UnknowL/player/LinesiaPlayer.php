...
final class LinesiaPlayer extends Player
{
	...
	{
		if ($this->getActiveInteraction(self::INTERACTION_INTERACT)) return;
	...
	final public function chat(string $message): bool
	{
		if (isset($this->onChatResponse)) $this->awaitChatResponse(function () {}, true, [$message]);
