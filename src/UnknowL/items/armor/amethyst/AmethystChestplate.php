...
class AmethystChestplate extends Armor implements ItemComponents
{
	...
	public function __construct(ItemIdentifier $identifier, string $name = "Plastron en Améthyste")
	{
		...
		parent::__construct($identifier, "Plastron en Améthyste", new ArmorTypeInfo(3, 1750, ArmorInventory::SLOT_CHEST));
		$creativeInfo = new CreativeInventoryInfo(CreativeInventoryInfo::CATEGORY_ITEMS, CreativeInventoryInfo::GROUP_HELMET);
		$this->initComponent("amethyste_chestplate", $creativeInfo);
